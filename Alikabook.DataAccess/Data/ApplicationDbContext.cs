...
namespace Alikabook.DataAccess.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookInfo>()
                .HasOne(b => b.Category)
                .WithMany(c => c.BookInfos)
                .HasForeignKey(b => b.CategoryId)
                .OnDelete(DeleteBehavior.Restrict); 

            modelBuilder.Entity<BookInfo>()
                .HasOne(b => b.Subcategory)
                .WithMany(sc => sc.BookInfos)
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { Id = 3, Name = "Business & Economics" },
                new Category { Id = 4, Name = "Programming & Technology" },
                new Category { Id = 5, Name = "Education & Teaching" },
                new Category { Id = 6, Name = "Children’s Books" },
                new Category { Id = 7, Name = "Graphic Novels & Comics" },
                new Category { Id = 8, Name = "Poetry & Drama" },
                new Category { Id = 9, Name = "Science & Nature" },
                new Category { Id = 10, Name = "Arts & Photography" },
                new Category { Id = 11, Name = "History" },
                new Category { Id = 12, Name = "Spirituality & Religion" },
                new Category { Id = 13, Name = "Lifestyle" },
                new Category { Id = 14, Name = "Miscellaneous" }
            );

            modelBuilder.Entity<Subcategory>().HasData(
                new Subcategory { Id = 1, Name = "Literary Fiction", CategoryId = 1 },
                new Subcategory { Id = 2, Name = "Mystery & Thriller", CategoryId = 1 },
                new Subcategory { Id = 3, Name = "Science Fiction & Fantasy", CategoryId = 1 },
                new Subcategory { Id = 4, Name = "Romance", CategoryId = 1 },
                new Subcategory { Id = 5, Name = "Historical Fiction", CategoryId = 1 },
                new Subcategory { Id = 6, Name = "Young Adult Fiction", CategoryId = 1 },

                new Subcategory { Id = 7, Name = "Biography & Memoir", CategoryId = 2 },
                new Subcategory { Id = 8, Name = "Self-Help", CategoryId = 2 },
                new Subcategory { Id = 9, Name = "Health & Wellness", CategoryId = 2 },
                new Subcategory { Id = 10, Name = "Travel", CategoryId = 2 },
                new Subcategory { Id = 11, Name = "Cooking & Food", CategoryId = 2 },
                new Subcategory { Id = 12, Name = "True Crime", CategoryId = 2 },
                new Subcategory { Id = 13, Name = "Politics & Current Events", CategoryId = 2 },

                new Subcategory { Id = 14, Name = "Entrepreneurship", CategoryId = 3 },
                new Subcategory { Id = 15, Name = "Management", CategoryId = 3 },
                new Subcategory { Id = 16, Name = "Personal Finance", CategoryId = 3 },
                new Subcategory { Id = 17, Name = "Marketing", CategoryId = 3 },
                new Subcategory { Id = 18, Name = "Investing", CategoryId = 3 },
                new Subcategory { Id = 19, Name = "Leadership", CategoryId = 3 },

                new Subcategory { Id = 20, Name = "Basic Programming", CategoryId = 4 },
                new Subcategory { Id = 21, Name = "Advanced Programming", CategoryId = 4 },
                new Subcategory { Id = 22, Name = "Web Development", CategoryId = 4 },
                new Subcategory { Id = 23, Name = "Data Science & AI", CategoryId = 4 },
                new Subcategory { Id = 24, Name = "Software Engineering", CategoryId = 4 },

                new Subcategory { Id = 25, Name = "Educational Materials", CategoryId = 5 },
                new Subcategory { Id = 26, Name = "Teaching Strategies", CategoryId = 5 },
                new Subcategory { Id = 27, Name = "Early Childhood Education", CategoryId = 5 },
                new Subcategory { Id = 28, Name = "Study Guides & Test Prep", CategoryId = 5 },

                new Subcategory { Id = 29, Name = "Picture Books", CategoryId = 6 },
                new Subcategory { Id = 30, Name = "Early Readers", CategoryId = 6 },
                new Subcategory { Id = 31, Name = "Chapter Books", CategoryId = 6 },
                new Subcategory { Id = 32, Name = "Middle Grade Fiction", CategoryId = 6 },

                new Subcategory { Id = 33, Name = "Manga", CategoryId = 7 },
                new Subcategory { Id = 34, Name = "Superhero Comics", CategoryId = 7 },
                new Subcategory { Id = 35, Name = "Independent Comics", CategoryId = 7 },

                new Subcategory { Id = 36, Name = "Poetry Collections", CategoryId = 8 },
                new Subcategory { Id = 37, Name = "Plays & Screenplays", CategoryId = 8 },

                new Subcategory { Id = 38, Name = "Biology", CategoryId = 9 },
                new Subcategory { Id = 39, Name = "Physics", CategoryId = 9 },
                new Subcategory { Id = 40, Name = "Environmental Science", CategoryId = 9 },
                new Subcategory { Id = 41, Name = "Astronomy", CategoryId = 9 },

                new Subcategory { Id = 42, Name = "Art History", CategoryId = 10 },
                new Subcategory { Id = 43, Name = "Photography Techniques", CategoryId = 10 },
                new Subcategory { Id = 44, Name = "Crafts & Hobbies", CategoryId = 10 },

                new Subcategory { Id = 45, Name = "Ancient History", CategoryId = 11 },
                new Subcategory { Id = 46, Name = "Modern History", CategoryId = 11 },
                new Subcategory { Id = 47, Name = "Military History", CategoryId = 11 },
                new Subcategory { Id = 48, Name = "World History", CategoryId = 11 },

                new Subcategory { Id = 49, Name = "Spiritual Growth", CategoryId = 12 },
                new Subcategory { Id = 50, Name = "World Religions", CategoryId = 12 },
                new Subcategory { Id = 51, Name = "Inspirational", CategoryId = 12 },

                new Subcategory { Id = 52, Name = "Home & Garden", CategoryId = 13 },
                new Subcategory { Id = 53, Name = "Hobbies & Crafts", CategoryId = 13 },
                new Subcategory { Id = 54, Name = "Fashion & Beauty", CategoryId = 13 },

                new Subcategory { Id = 55, Name = "Reference Books", CategoryId = 14 },
                new Subcategory { Id = 56, Name = "Language Learning", CategoryId = 14 },
                new Subcategory { Id = 57, Name = "Humor", CategoryId = 14 }
            );
